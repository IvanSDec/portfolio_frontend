const skills = ['React', 'Python', 'Node', 'Github', 'Blender'];
...
export default function InformationHome() {
	...
	return (
		...
		<div className="w-full min-h-[100vh] bg-[#3d3d3d] p-[30px] md:p-[70px] md:flex md:items-start md:justify-between">	

            <div className="w-1/2 h-full">

                <div className="w-full h-auto max-w-[600px] mr-0">
                    <h2 className="text-yellow-500 text-[40px] md:text-[60px] mb-14 font-bebas">Hola, yo soy Iván S. Carrillo</h2>
                    <p className="text-white text-md mb-4 font-jura max-w-[500px]"><span className="font-bold">Desarrollador Web Fullstack</span>, tengo una gran pasión por la tecnología en general, lo que provocó mi gusto y fascinación por el desarrollo de aplicaciones web y modelado 3D.</p>
            ...
            <div className="w-1/2 h-[80vh] flex justify-end items-center flex-col p-[40px]">
